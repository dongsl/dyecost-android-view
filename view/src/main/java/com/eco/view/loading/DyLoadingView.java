...
import com.eco.view.loading.indicators.BallPulseIndicator;

public class DyLoadingView extends View {

  private static final String TAG = "DyLoadingView";
  ...
  public DyLoadingView(Context context, AttributeSet attrs) {
    super(context, attrs);
    init(context, attrs, 0, R.style.DyLoadingView);
  }

  public DyLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
    super(context, attrs, defStyleAttr);
    init(context, attrs, defStyleAttr, R.style.DyLoadingView);
  }

  @TargetApi(Build.VERSION_CODES.LOLLIPOP)
  public DyLoadingView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
  ...
  private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    mMinHeight = a.getDimensionPixelSize(R.styleable.DyLoadingView_minHeight, mMinHeight);
    mMaxHeight = a.getDimensionPixelSize(R.styleable.DyLoadingView_maxHeight, mMaxHeight);
    String indicatorName = a.getString(R.styleable.DyLoadingView_indicatorName);
    mIndicatorColor = a.getColor(R.styleable.DyLoadingView_indicatorColor, Color.WHITE);
