 ...
 * 垂直方向上下滑动阻尼效果
 * -----------------demo-----------------
 * <DyVerticalDampenScrollView
 * android:layout_width="match_parent"
 * android:layout_height="wrap_content">
 * <LinearLayout/>
 * </DyVerticalDampenScrollView>
 */
public class DyVerticalDampenScrollView extends ScrollView {
    ...
    //------尾部收缩属性end--------
    public DyVerticalDampenScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void commOnTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                int deltaY = (int) (preY - nowY) / 2;// 滑动距离
                if (!isCount) {
                    deltaY = 0; // 在这里要归0.
                }
                y = nowY;
                ...
                // 处理放大
                mScaling = true;
                //setZoom(1 + distance);  //暂时没有需要 开启下拉放大第一个view
                //头部处理end
                break;
        }
    }
